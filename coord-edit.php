...
<body>
	...
	<CENTER>
		...
		<table>
			<form method="POST"
				action="coord-edit.php?pkname=<?php echo $pkname; ?>&id=<?php echo $id; ?>&table=<?php echo $table; ?>">
				<tr>
					<td>Title</td>
					<td>
						<input
				...
				<tr>
					...
					<td>
						<select name="mod_land">
							<option value="1" <?php if($edit_r->landmark == 1){ echo "selected";} ?> >Designated</option>
							<option value="0" <?php if($edit_r->landmark == NULL || $edit_r->landmark == 0){ echo "selected";}  ?>>Not Designated</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select name="mod_hamlet">
							<option value="1" <?php if($edit_r->hamlet==1){echo "selected";}?>>New Paltz</option>
							<option value="2"<?php if($edit_r->hamlet==2){echo "selected";}?>>Bonticou</option>
							<option value="3"<?php if($edit_r->hamlet==3){echo "selected";}?>>Butterville</option>
							<option value="4"<?php if($edit_r->hamlet==4){echo "selected";}?>>Libertyville</option>
							<option value="5"<?php if($edit_r->hamlet==5){echo "selected";}?>>Middletown</option>
							<option value="6"<?php if($edit_r->hamlet==6){echo "selected";}?>>Ohioville</option>
							<option value="7"<?php if($edit_r->hamlet==7){echo "selected";}?>>Plutarch</option>
							<option value="8"<?php if($edit_r->hamlet==8){echo "selected";}?>>Springtown</option>
							<option value="9"<?php if($edit_r->hamlet==9){echo "selected";}?>>Downtown</option>
							<option value="10"<?php if($edit_r->hamlet==10){echo "selected";}?>>Jenkinstown</option>
						</select>
					</td>
				</tr>
				<tr>
		...
		if (
			...
			isset($_POST['mod_lat']) &&
			isset($_POST['mod_lng']) &&
			isset($_POST['mod_land']) &&
			isset($_POST['mod_hamlet']) &&
			// For the data field
			...
			$mod_land = $_POST['mod_land'];
			$mod_hamlet = $_POST['mod_hamlet'];
			// For the data field
			...
			$query = "UPDATE a_all_items SET title=?, main_content=?, report=?, data=?, lat=?, lng=?, hamlet=?, landmark=? WHERE cid = ?;";
			...
			if ($stmt) {
				...
				if (mysqli_stmt_execute($stmt)) {
					...
					header("location: coord-entry.php");
				} else {
