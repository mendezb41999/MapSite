...
$myask = "SELECT * FROM a_all_items WHERE lat=0 OR lng=0 ORDER BY cid ASC";
...
<body>
	...
	<CENTER>
		...
		<div class="property-header">
			<h2>List Of All Properties without a lat/lng.</h2>
			<h2>FYI: Not all of these items need a lat/lng. Some are pages that were for other purposes i.e. donate,test,etc.</h2>
		</div>
		<table border="0" cellpadding="5" style="border-collapse: collapse; ">
			<tbody id="table-body">
				...
				function hrefFix_two($id, $col) {
					echo "coord-edit.php?pkname=cid&id=" . $id
