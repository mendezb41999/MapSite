...
<html>
    ...
    <body>
        <div id="map"></div>
	<div id="legend"><h2 style="margin-top: 0px; margin-bottom: 20px">Legend</h2></div>
           <?php                   
		   		if (isset($_GET["keyword"])){
				$keyword = $_GET["keyword"];
                require 'config.php';
                $query= "SELECT cid,title,lat,lng,`data`,landmark FROM a_all_items WHERE title LIKE '%$keyword%'" ;
